...
const double GeneralLinearModel::getMean() const { return 0.0; }
...
std::vector<double> GeneralLinearModel::Simulate(const double start,
...
const double GeneralLinearModel::coreEquation(const double& x,
                                              const double& noise,
                                              const unsigned int& t) const {
