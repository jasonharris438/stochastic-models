...
class PredictedObservation {
   ...
   public:
     ...
     *
     */
    PredictedObservation(matrix<double> observation_matrix,
                         double observation_offset);
    /**
...
struct PriorState {
    ...
    PriorState(const int &state_mean_dimension,
...
struct PosteriorState {
    ...
    PosteriorState(const int &state_mean_dimension,
                   const int &state_covariance_rows,
                   const int &state_covariance_columns);
};
...
struct TransitionState {
    ...
    TransitionState(const int &state_covariance_rows,
                    const int &state_covariance_columns);
};
...
class FilterGeneralSde {
   ...
   public:
    FilterGeneralSde();
    FilterGeneralSde(const double &mu, const double &sigma,
                     const double &conditional_variance,
                     const double &mu_numerator, const double &mu_denominator,
...
struct FilterSystemDimensions {
    ...
    FilterSystemDimensions(int state_mean_dimension, int state_covariance_rows,
                           int state_covariance_columns,
                           int observation_matrix_rows,
                           int observation_matrix_columns,
                           int observation_covariance_rows,
...
class KcaStates {
   private:
     ...
     */
    void move_std_vector_to_vector(std::vector<double> &&vector_as_vector,
   ...
   public:
     ...
     */
    void setInitialState(const std::vector<double> &data_series,
     ...
     * data.
     */
    void updateCurrentState(const double &observation,
