...
const double optimalExitLevel(
  ...
  try {
    ...
    std::cout << "Exception " << e.what()
              << " caught in optimalExitLevel without stop loss." << std::endl;
    throw;
  }
  return value;
}
...
const double optimalEntryLevel(
  ...
  try {
    ...
    std::cout << "Exception " << e.what()
              << " caught in optimalEntryLevel without stop loss." << std::endl;
    throw;
  }
  return value;
}
...
const double optimalEntryLevelLowerExponential(
  ...
  try {
    ...
    std::cout << "Exception " << e.what()
              << " caught in optimalEntryLevelLowerExponential." << std::endl;
    throw;
  }
  return value;
}
const double optimalEntryLevelLower(
  ...
  try {
    // Calculate d*.
    value = tradingLevels.optimalEntryLower(d_star, b_star, stop_loss, r, c);
...
const double optimalEntryLevel(
  ...
  try {
    ...
    std::cout << "Exception " << e.what()
              << " caught in optimalEntryLevel with stop loss." << std::endl;
    throw;
  }
  return value;
}
