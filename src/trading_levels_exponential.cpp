...
OrnsteinUhlenbeckTradingLevelsExponential::getModel() const {
  return model.get();
};
...
const StochasticModel*
OrnsteinUhlenbeckTradingLevelsExponential::newModel() const {
...
const double
OrnsteinUhlenbeckTradingLevelsExponential::optimalExitUpperBound() const {
  return upperSolverBound(getModel());
}
const double
OrnsteinUhlenbeckTradingLevelsExponential::optimalEntryLowerBound() const {
...
const double OrnsteinUhlenbeckTradingLevelsExponential::optimalExit(
  ...
  // struct.
  void* params = new ExitLevelParams{
      optimizer->clone(), hitting_time_kernel->clone(), r, c
  };
  ModelFunc fn = funcOptimalMeanReversionB;
