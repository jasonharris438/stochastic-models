...
class BoostMartixInverter {
   private:
     ...
     */
    void linalgInvertMatrix(gsl_matrix* gsl_mat, gsl_permutation* perm,
     ...
     */
    const boost::numeric::ublas::matrix<double> copyGslToBoostMatrix(
        const gsl_matrix* gsl_mat) const;
   ...
   public:
     ...
     */
    const boost::numeric::ublas::matrix<double> invertMatrix(
