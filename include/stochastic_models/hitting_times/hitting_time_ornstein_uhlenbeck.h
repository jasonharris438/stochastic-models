...
class HittingTimeOrnsteinUhlenbeck {
   ...
   public:
    HittingTimeOrnsteinUhlenbeck(const double mu, const double alpha,
                                 const double sigma);
     ...
     * evaluated at x.
     */
    const double optimalTradingFCore(const double& x, const double& u,
     ...
     * evaluated at x.
     */
    const double optimalTradingGCore(const double& x, const double& u,
                                     const double& r) const;
    /**
